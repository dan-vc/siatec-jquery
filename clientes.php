    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <form class="form-inline m-2 my-lg-0">
                            ...
                            <input type="search" id="search-cliente" name="" value="" class="form-control mr-sm-2"
                                placeholder="Busque al cliente">
                ...
                <script type="text/javascript" src="js/clientes.js">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form id="clientes-form">
                            ...
                            <input type="hidden" name="" id="clienteId">

                            <div class="form-group">

                                <input type="text" id="nombre" placeholder="Nombre del cliente" name="nombre" value=""
                                    class="form-control">
