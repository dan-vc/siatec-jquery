                ...
                <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                    ...
                    <div class="collapse navbar-collapse" id="collapsibleNavId">
                        <ul class="navbar-nav me-auto mt-2 mt-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="trabajadores.php">Trabajadores</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <form class="form-inline m-2 my-lg-0">
                            ...
                            <input type="search" id="search-trabajador" name="" value="" class="form-control mr-sm-2"
                                placeholder="Busque al trabajador">
    ...
    <div class="container p-4">
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form id="trabajadores-form">

                            <input type="hidden" name="" id="trabajadorId">

                            <div class="form-group">

                                <input type="text" id="nombre" placeholder="Nombre del trabajador" name="nombre" value=""
                                    class="form-control">
            ...
            <div class="col-md-7">
                ...
                <div class="card my-4" id="resultado-trabajador">
